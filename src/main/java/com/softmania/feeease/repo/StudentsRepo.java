...
public interface StudentsRepo extends JpaRepository<Students, Integer> {
    ...
    List<Students> getFeesNotPaidByStudentByMonthYear(int schoolId, String depositMonthYear);
    ...
    List<Students> findBySessionIdAndStandardId(int sessionId, int standardId);
}
